...
namespace Gigadrillgames.AUP.Tools
{
    public class LocalNotificationPlugin : MonoBehaviour
    {
        ...
        private void SetNotificationCallbackListener(Action<string> onNotificationLoadComplete,
            Action onNotificationLoadFail)
        {
#if UNITY_ANDROID
            if (Application.platform == RuntimePlatform.Android)
            {
        ...
        public void ScheduleNotification(string notificationTitle, string notificationMessage,
            string notificationTickerMessage, int delay, bool enableVibrate, bool enableSound, int requestCode,
            string channelID, string channelName)
        {
#if UNITY_ANDROID
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("scheduleNotification", notificationTitle, notificationMessage, notificationTickerMessage,
                    delay, enableVibrate, enableSound, requestCode, channelID, channelName);
            }
            else
            {
                Utils.Message(TAG, "warning: must run in actual android device");
        ...
        /// <param name="enableVibrate">If set to <c>true</c> enable vibrate.</param>
        /// <param name="enableSound">If set to <c>true</c> enable sound.</param>
        public void ScheduleSpecificNotification(string notificationTitle, int requestCode, int hour, int minute,
            int sec, int amOrPm, string notificationMessage, string notificationTickerMessage,
            bool enableVibrate, bool enableSound, string channelID, string channelName)
        {
#if UNITY_ANDROID
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("scheduleSpecificNotification", notificationTitle, requestCode, hour, minute, sec, amOrPm,
                    notificationMessage, notificationTickerMessage, enableVibrate, enableSound,
        ...
        )
        {
            ...
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("scheduleEveryDay", notificationTitle, requestCode, hour, minute, sec, amOrPm,
                    notificationMessage, notificationTickerMessage, enableVibrate, enableSound,
                    channelID, channelName);
            }
            else
        ...
        )
        {
            ...
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("scheduleAfterDay", notificationTitle, requestCode, day, hour, minute, sec, amOrPm,
                    notificationMessage, notificationTickerMessage, enableVibrate, enableSound, channelID, channelName);
            }
            else
            {
                Utils.Message(TAG, "warning: must run in actual android device");
        ...
        )
        {
            ...
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("scheduleShortTime", notificationTitle, requestCode, day, hour, minute, sec,
                    notificationMessage, notificationTickerMessage,
        ...
        )
        {
            ...
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("scheduleLongTime", notificationTitle, requestCode, year, month, week, day, hour, minute,
                    sec, notificationMessage, notificationTickerMessage,
                    enableVibrate, enableSound, channelID, channelName);
            }
            else
            {
