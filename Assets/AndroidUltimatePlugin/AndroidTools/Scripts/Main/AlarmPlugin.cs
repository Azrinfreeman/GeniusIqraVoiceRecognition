    ...
    public class AlarmPlugin : MonoBehaviour
    {
        ...
        public void EnableVibrate(bool val)
        {
            ...
            if (Application.platform == RuntimePlatform.Android)
            {
                ...
                Utils.Message(TAG, "EnableVibrate");
            }
            else
            {
                Utils.Message(TAG, "warning: must run in actual android device");
        ...
        public void SetAlarm(int requestCode, int hour, int minute, int sec, int amOrPm, string alarmTile,
            string alarmMessage, string alarmTickerMessage,
            string channelID, string channelName)
        {
#if UNITY_ANDROID
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("setAlarm", requestCode, hour, minute, sec, amOrPm, alarmTile, alarmMessage,
                    alarmTickerMessage, channelID, channelName);
            }
            else
            {
                Utils.Message(TAG, "warning: must run in actual android device");
        ...
        /// <param name="alarmMessage">Alarm message.</param>
        /// <param name="alarmTickerMessage">Alarm ticker message.</param>
        public void SetExactAlarm(int requestCode, int hour, int minute, int sec, int amOrPm, string alarmTile,
            string alarmMessage, string alarmTickerMessage,
            string channelID, string channelName)
        {
#if UNITY_ANDROID
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("setExactAlarm", requestCode, hour, minute, sec, amOrPm, alarmTile, alarmMessage,
                    alarmTickerMessage, channelID, channelName);
            }
            else
            {
        ...
        /// <param name="alarmMessage">Alarm message.</param>
        /// <param name="alarmTickerMessage">Alarm ticker message.</param>
        public void SetAlarmAfterDay(int requestCode, int day, int hour, int minute, int sec, int amOrPm,
            string alarmTile, string alarmMessage, string alarmTickerMessage,
            string channelID, string channelName)
        {
#if UNITY_ANDROID
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("setAlarmAfterDay", requestCode, day, hour, minute, sec, amOrPm, alarmTile, alarmMessage,
                    alarmTickerMessage, channelID, channelName);
            }
            else
            {
        ...
        /// <param name="alarmMessage">Alarm message.</param>
        /// <param name="alarmTickerMessage">Alarm ticker message.</param>
        public void SetRepeatingAlarm(int requestCode, int hour, int minute, int sec, int amOrPm, long delay,
            string alarmTile, string alarmMessage, string alarmTickerMessage,
            string channelID, string channelName)
        {
#if UNITY_ANDROID
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("setRepeatingAlarm", requestCode, hour, minute, sec, amOrPm, delay, alarmTile,
                    alarmMessage, alarmTickerMessage, channelID, channelName);
            }
            else
            {
                Utils.Message(TAG, "warning: must run in actual android device");
        ...
        /// <param name="alarmMessage">Alarm message.</param>
        /// <param name="alarmTickerMessage">Alarm ticker message.</param>
        public void SetInExactRepeatingAlarm(int requestCode, int hour, int minute, int sec, int amOrPm, long delay,
            string alarmTile, string alarmMessage, string alarmTickerMessage,
            string channelID, string channelName)
        {
#if UNITY_ANDROID
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("setInExactRepeatingAlarm", requestCode, hour, minute, sec, amOrPm, delay, alarmTile,
                    alarmMessage, alarmTickerMessage, channelID, channelName);
            }
            else
            {
        ...
        /// <param name="alarmMessage">Alarm message.</param>
        /// <param name="alarmTickerMessage">Alarm ticker message.</param>
        public void SetInExactRepeatingAlarmElapseRealTimeWakeUp(int requestCode, int hour, int minute, int sec,
            int amOrPm, long delay, string alarmTile, string alarmMessage, string alarmTickerMessage,
            string channelID, string channelName)
        {
#if UNITY_ANDROID
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("setInExactRepeatingAlarmElapseRealTimeWakeUp", requestCode, hour, minute, sec, amOrPm,
                    delay, alarmTile, alarmMessage, alarmTickerMessage, channelID, channelName);
            }
            else
            {
                Utils.Message(TAG, "warning: must run in actual android device");
        ...
        /// <param name="alarmMessage">Alarm message.</param>
        /// <param name="alarmTickerMessage">Alarm ticker message.</param>
        public void SetInExactPerDayRepeatingAlarm(int requestCode, int hour, int minute, int sec, int amOrPm,
            string alarmTile, string alarmMessage, string alarmTickerMessage,
            string channelID, string channelName)
        {
#if UNITY_ANDROID
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("setInExactPerDayRepeatingAlarm", requestCode, hour, minute, sec, amOrPm, alarmTile,
                    alarmMessage, alarmTickerMessage, channelID, channelName);
            }
            else
            {
