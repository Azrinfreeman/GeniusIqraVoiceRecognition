...
namespace Gigadrillgames.AUP.Tools
{
    public class LocalNotificationDemo : MonoBehaviour
    {
        ...
        public void ScheduleLocalNotification()
        {
            ...
            localNotificationPlugin.ScheduleNotification("my notification title", "my notification message",
                "my notification ticker message",
        ...
        public void ScheduleSpecificLocalNotification()
        {
            ...
            localNotificationPlugin.ScheduleSpecificNotification(requestCode + "ntifcation title", requestCode, hour,
                minute, sec, amOrPM,
        ...
        public void ScheduleMultipleSpecificLocalNotification()
        {
            ...
            for (int i = 0; i < len; i++)
            {
                ...
                localNotificationPlugin.ScheduleSpecificNotification(requestCode + "mltiple notifcation title",
                    requestCode, hour, minute, sec, amOrPM,
                    "my notification message_" + i, "my notification ticker message_" + i, true, true, channelID,
                    channelName);
        ...
        public void ScheduleMultipleNotification()
        {
            ...
            for (int index = 0; index < notificationCount; index++)
            {
                ...
                localNotificationPlugin.ScheduleNotification(requestCode + "notification title",
        ...
        public void ScheduleNotificationAfterDay()
        {
            ...
            localNotificationPlugin.ScheduleAfterDay(requestCode + "notifcation title", requestCode, day, hour, minute,
                sec,
                amOrPM, "my notification message", "my notification ticker message", true, true, channelID,
                channelName);
        ...
        public void ScheduleShortTime()
        {
            ...
            localNotificationPlugin.ScheduleShortTime(requestCode + "notifcation title", requestCode, day, hour, minute,
                sec,
                "my notification message", "my notification ticker message", true, true, channelID, channelName);
        ...
        public void ScheduleLongTime()
        {
            ...
            localNotificationPlugin.ScheduleLongTime(requestCode + "notifcation title", requestCode, year, month, week,
                day, hour, minute, sec,
                "my notification message", "my notification ticker message", true, true, channelID, channelName);
