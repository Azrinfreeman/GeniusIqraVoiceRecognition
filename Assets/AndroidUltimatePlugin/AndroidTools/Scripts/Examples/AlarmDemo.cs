...
namespace Gigadrillgames.AUP.Tools
{
    public class AlarmDemo : MonoBehaviour
    {
        ...
        public void SetAlarm()
        {
            ...
            alarmPlugin.SetAlarm(requestCode, hour, minute, sec, amOrPM, "alarm notification title",
                "my alarm notification message", "my alarm notification ticker message",
        ...
        public void SetExactAlarm()
        {
            ...
            alarmPlugin.SetExactAlarm(requestCode, hour, minute, sec, amOrPM, "alarm notification title" + requestCode,
                "my alarm notification message", "my alarm notification ticker message",
                channelID, channelName);
        ...
        public void SetRepeatingAlarm()
        {
            ...
            alarmPlugin.SetRepeatingAlarm(requestCode, hour, minute, sec, amOrPM, delayInterval,
                "alarm notification title" + requestCode, "my alarm notification message",
                "my alarm notification ticker message",
                channelID, channelName);
        ...
        public void SetInExactRepeatingAlarm()
        {
            ...
            alarmPlugin.SetInExactRepeatingAlarm(requestCode, hour, minute, sec, amOrPM, delayInterval,
                "alarm notification title" + requestCode, "my alarm notification message",
                "my alarm notification ticker message",
                channelID, channelName);
        ...
        public void SetInExactPerDayRepeatingAlarm()
        {
            ...
            alarmPlugin.SetInExactPerDayRepeatingAlarm(requestCode, hour, minute, sec, amOrPM,
                "alarm notification title" + requestCode, "my alarm notification message",
                "my alarm notification ticker message",
                channelID, channelName);
